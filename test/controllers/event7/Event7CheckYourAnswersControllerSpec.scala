  ...
  "Check Your Answers Controller for Event 7" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        ...
        contentAsString(result) mustEqual view(list, "/manage-pension-scheme-event-report/new-report/event-7-click")(request, messages(application)).toString
      }
    }
...
object Event7CheckYourAnswersControllerSpec {
  ...
  private def expectedMemberSummaryListRowsEvent7(implicit messages: Messages): Seq[SummaryListRow] = Seq(
    fakeSummaryListRowWithHtmlContentWithHiddenContent(
      ...
      "Joe Bloggs",
      "/manage-pension-scheme-event-report/new-report/1/event-7-member-details?waypoints=event-7-check-answers-1",
    ...
    fakeSummaryListRowWithHtmlContentWithHiddenContent(
      ...
      "£100.00",
      "/manage-pension-scheme-event-report/new-report/1/event-7-lump-sum-amount?waypoints=event-7-check-answers-1",
      "lumpSumAmount.change.hidden"
    ),
    fakeSummaryListRowWithHtmlContentWithHiddenContent(
      "crystallisedAmount.checkYourAnswersLabel",
      "£50.00",
      "/manage-pension-scheme-event-report/new-report/1/event-7-crystallisation-amount?waypoints=event-7-check-answers-1",
      "crystallisedAmount.change.hidden"
    ),
    fakeSummaryListRowWithTextWithHiddenContent(
      "paymentDate.date.checkYourAnswersLabel",
      "08 November 2022",
      "/manage-pension-scheme-event-report/new-report/1/event-7-payment-date?waypoints=event-7-check-answers-1",

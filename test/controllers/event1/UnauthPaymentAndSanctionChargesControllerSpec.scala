...
class UnauthPaymentAndSanctionChargesControllerSpec extends SpecBase {

  "UnauthPaymentAndSanctionCharges Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        ...
        val request = FakeRequest(GET, routes.UnauthPaymentAndSanctionChargesController.onPageLoad().url)

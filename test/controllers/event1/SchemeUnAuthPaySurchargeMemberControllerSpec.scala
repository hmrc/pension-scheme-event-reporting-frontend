...
import views.html.event1.SchemeUnAuthPaySurchargeMemberView

import scala.concurrent.Future

class SchemeUnAuthPaySurchargeMemberControllerSpec extends SpecBase with BeforeAndAfterEach with MockitoSugar {

  private val waypoints = EmptyWaypoints

  private val formProvider = new SchemeUnAuthPaySurchargeMemberFormProvider()
  ...
  "SchemeUnAuthPaySurchargeMember Controller" - {

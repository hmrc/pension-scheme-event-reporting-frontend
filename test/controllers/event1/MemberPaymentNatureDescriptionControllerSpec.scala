...
import pages.event1.MemberPaymentNatureDescriptionPage
...
class MemberPaymentNatureDescriptionControllerSpec extends SpecBase with BeforeAndAfterEach {
  ...
  private val formProvider = new MemberPaymentNatureDescriptionFormProvider()
  ...
  "MemberPaymentNatureDescription Controller" - {

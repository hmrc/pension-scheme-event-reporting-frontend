...
class MemberTangibleMoveablePropertyControllerSpec extends SpecBase with BeforeAndAfterEach with MockitoSugar {

  private val waypoints = EmptyWaypoints

  private val formProvider = new MemberTangibleMoveablePropertyFormProvider()
  ...
  "MemberTangibleMoveableProperty Controller" - {

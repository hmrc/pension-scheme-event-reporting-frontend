...
object Event8CheckYourAnswersControllerSpec {
  ...
  private def fakeSummaryListRowWithHtmlContentWithHiddenContentNoChange(messageKey: String,
                                                                         htmlContent: String,
                                                                         changeLink: String,
                                                                         hiddenContentChangeLink: String)
                                                                        (implicit messages: Messages): SummaryListRow =
    SummaryListRow(Key(Text(messages(messageKey)), ""),
      Value(HtmlContent(htmlContent), ""),
      "",
  ...
  private def expectedMemberSummaryListRowsEvent8(implicit messages: Messages): Seq[SummaryListRow] = Seq(
    ...
    fakeSummaryListRowWithHtmlContentWithHiddenContentNoChange(

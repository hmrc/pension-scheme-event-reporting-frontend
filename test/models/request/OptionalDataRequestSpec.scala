...
import models.enumeration.AdministratorOrPractitioner.Practitioner
...
class OptionalDataRequestSpec extends SpecBase {
  ...
  "isReportSubmitted" - {
    ...
    "must return true when getVersionInfo status is Submitted" in {
      ...
      val dataRequest = OptionalDataRequest("", "", "", request, LoggedInUser("user", Practitioner, "pspId"), Some(ua), "S2400000041")

...
class EmployerTangibleMoveablePropertyFormProviderSpec extends StringFieldBehaviours {

  private val lengthKey = "employerTangibleMoveableProperty.error.length"
  private val maxLength = 160

  private val form = new EmployerTangibleMoveablePropertyFormProvider()()
  ...
  ".value" - {
    ...
    "not bind empty data" in {
      ...
      result.errors mustBe List(FormError("value", List("employerTangibleMoveableProperty.error.required"), List()))
    }
  }
}

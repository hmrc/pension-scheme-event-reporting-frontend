...
import models.enumeration.EventType.{Event1, Event22, Event23, Event6, Event8, Event25}
...
case class ManualOrUploadPage(eventType: EventType, index: Int) extends QuestionPage[ManualOrUpload] {
  ...
  override protected def nextPageNormalMode(waypoints: Waypoints, answers: UserAnswers): Page =
    (eventType, index, answers.get(this)) match {
      ...
      case (Event1, _, Some(FileUpload)) => pages.event1.FileUploadWhatYouWillNeedPage
      ...
      case (Event25, index, Some(Manual)) => pages.event25.WhatYouWillNeedPage(index)
      case _ => this
    }

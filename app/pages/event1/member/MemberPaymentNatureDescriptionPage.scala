...
case class MemberPaymentNatureDescriptionPage(index: Int) extends QuestionPage[String] {
  ...
  override def route(waypoints: Waypoints): Call =
    routes.MemberPaymentNatureDescriptionController.onPageLoad(waypoints, index)

...
case class MemberTangibleMoveablePropertyPage(index: Int) extends QuestionPage[String] {
  ...
  override def route(waypoints: Waypoints): Call =
    routes.MemberTangibleMoveablePropertyController.onPageLoad(waypoints, index)

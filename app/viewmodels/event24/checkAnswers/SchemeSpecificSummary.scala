...
object SchemeSpecificSummary {

  def row(waypoints: Waypoints, index: Index, sourcePage: CheckAnswersPage, isReadOnly: Boolean)
         (implicit messages: Messages): SummaryListRow =
    SummaryListRow(
      key     = "schemeSpecific.event24.checkYourAnswersLabel",

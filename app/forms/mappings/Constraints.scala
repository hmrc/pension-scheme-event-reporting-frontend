...
trait Constraints {
  ...
  val employerIdRefDigitsRegex = "^[0-9]{3}[0-9a-zA-Z/]{2,11}$"
  val employerIdRefNoSlashRegex = "^[0-9]{3}/[0-9a-zA-Z]{1,10}"
  val employerIdRefDisallowedCharsRegex = "[A-Za-z0-9/]{5,14}"

...
class EarlyBenefitsBriefDescriptionController @Inject()(val controllerComponents: MessagesControllerComponents,
                                                        identify: IdentifierAction,
                                                        getData: DataRetrievalAction,
                                                        userAnswersCacheConnector: UserAnswersCacheConnector,
                                                        formProvider: EarlyBenefitsBriefDescriptionFormProvider,
                                                        view: EarlyBenefitsBriefDescriptionView

...
class CompanyDetailsController @Inject()(val controllerComponents: MessagesControllerComponents,
      ...
      form.bindFromRequest().fold(
        ...
        value => {
          ...
          userAnswersCacheConnector.save(request.pstr, eventType, updatedAnswers).map { _ =>
            Redirect(CompanyDetailsPage.navigate(waypoints, originalUserAnswers, updatedAnswers).route)
          }
        }
      )
  }

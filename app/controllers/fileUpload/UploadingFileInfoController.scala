...
import views.html.common.UploadingFileInfoView

import javax.inject.Inject

class UploadingFileInfoController @Inject()(val controllerComponents: MessagesControllerComponents,
                                           identify: IdentifierAction,
                                           getData: DataRetrievalAction,
                                            view: UploadingFileInfoView

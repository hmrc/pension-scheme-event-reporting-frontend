...
trait UserAnswersEntryGenerators extends PageGenerators with ModelGenerators {
  ...
  implicit lazy val arbitraryMembersDetailsUserAnswersEntry: Arbitrary[(pages.event1.MembersDetailsPage, JsValue)] =
    Arbitrary {
      for {
        page <- arbitrary[pages.event1.MembersDetailsPage]

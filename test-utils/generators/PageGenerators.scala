...
trait PageGenerators {
  ...
  implicit lazy val arbitraryUnauthorisedPaymentRecipientNamePage: Arbitrary[event1.UnauthorisedPaymentRecipientNamePage.type] =
    Arbitrary(event1.UnauthorisedPaymentRecipientNamePage)
